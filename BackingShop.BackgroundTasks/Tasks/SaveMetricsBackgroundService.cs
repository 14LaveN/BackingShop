...
internal sealed class SaveMetricsBackgroundService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        stoppingToken.Register(() => _logger.LogDebug("SaveMetricsBackgroundService background task is stopping."));

        while (!stoppingToken.IsCancellationRequested)
        {
            _logger.LogDebug("SaveMetricsBackgroundService background task is doing background work.");
        ...
        _logger.LogDebug("SaveMetricsBackgroundService background task is stopping.");
